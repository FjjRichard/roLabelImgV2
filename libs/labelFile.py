...
class LabelFile(object):
    ...
    def savePascalVocFormat(self, filename, shapes, imagePath, imageData,
        ...
        for shape in shapes:
            ...
            if not isRotated:
                ...
                robndFourbox = LabelFile.convertPoints2RotatedFourBndBox(shape)
                writer.addRotatedBndBox(robndbox[0], robndbox[1],
                                        robndbox[2], robndbox[3], robndbox[4], robndFourbox,label, difficult)
    ...
    def convertPoints2RotatedFourBndBox(shape):
        points = shape['points']
        x1 = points[0][0]
        y1 = points[0][1]
        ...
        return (round(x1, 4), round(y1, 4), round(x2, 4), round(y2, 4), round(x3, 4), round(y3, 4), round(x4, 4), round(y4, 4))
